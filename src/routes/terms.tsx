...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of service — RoomEasy" },
      { name: "description", content: "The rules for booking, hosting, cancelling and paying on RoomEasy." },
      { property: "og:title", content: "Terms of service — RoomEasy" },
      { property: "og:description", content: "The rules for booking, hosting, cancelling and paying on RoomEasy." },
